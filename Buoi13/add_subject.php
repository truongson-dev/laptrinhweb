...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($tenMH) || $sotinchi <= 0) {
        ...
        // Thêm môn học với Prepared Statement
        $sql = "INSERT INTO monhoc (ten_MH, sotinchi) VALUES (?, ?)";
        $stmt = mysqli_prepare($conn, $sql);
        mysqli_stmt_bind_param($stmt, "si", $tenMH, $sotinchi);
...
<body>
    <header>
        <div class="header-content">
            <h1><i class="fas fa-book-medical"></i> UpStudy</h1>
            <nav>
                <ul>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-book-medical"></i> Thông tin môn học</h2>
